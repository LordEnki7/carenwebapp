...
export async function sendEmergencyEmail(
  ...
  try {
    ...
    const userName = alertData.userName || 'C.A.R.E.N.™ Alert User';
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>C.A.R.E.N.™ Alert Emergency Notification System</p>
          </div>
          <div class="content">
            ...
            <p>This alert was automatically generated by the C.A.R.E.N.™ Alert emergency system when ${userName} activated emergency voice commands.</p>
          </div>
          <div class="footer">
    ...
    const textContent = `
🚨 EMERGENCY ALERT - C.A.R.E.N.™ Alert System
...
This alert was automatically generated by the C.A.R.E.N.™ Alert emergency system.
    `;
...
This recording was sent via voice command from the C.A.R.E.N.™ Alert legal protection platform.
The client requires immediate legal attention.

Please review and respond to the client's situation promptly.

C.A.R.E.N.™ Alert Legal Protection Platform
...
<body>
    <div class="container">
        ...
        <div class="urgent">
            ...
            <p>Your client <strong>${userName}</strong> has sent you evidence via the C.A.R.E.N.™ Alert legal protection platform using voice command activation.</p>
        </div>
        ...
        <div class="footer">
            <p><strong>C.A.R.E.N.™ Alert Legal Protection Platform</strong><br>
